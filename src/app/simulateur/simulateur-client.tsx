        ...
        <fieldset className="grid gap-3 rounded-xl border border-[#D8E2F0] bg-[#EEF4FF] p-4">
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`rounded-lg px-4 py-2 text-sm font-semibold ${!smoker ? "bg-[#3B82F6] text-white" : "bg-[#FFFFFF] text-[#475569]"}`}
            >
              Non
            </button>
            <button
      ...
      <aside className="glass-card flex flex-col justify-between p-6 sm:p-8">
        <div>
          ...
          <div className="mt-8 grid gap-5">
            <div>
              <span className="text-sm font-semibold text-[#475569]">Taux estimatif</span>
              <strong className="mt-2 block text-5xl font-black text-gradient">{result.rate}%</strong>
            </div>
            <div>
              <span className="text-sm font-semibold text-[#475569]">Prime mensuelle estimée</span>
              <strong className="mt-2 block text-4xl font-black text-[#0F172A]">{result.monthlyPremium} €</strong>
            </div>
          </div>
        </div>
        <p className="mt-8 rounded-xl border border-[#D8E2F0] bg-[#EEF4FF] p-4 text-sm leading-6 text-[#475569]">
